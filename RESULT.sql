...
-- Find the total number of movies released in each year. How does the trend look month-wise? (Output expected)
...
-- Rank actors with movies released in India based on their average ratings. Which actor is at the top of the
-- list?
...
-- Find the top five actresses in Hindi movies released in India based on their average ratings.
...
-- Which are the five highest-grossing movies in each year for each of the top three genres?
...
-- Who are the top 3 actresses based on the number of Super Hit movies (average rating > 8) in 'drama' genre?
